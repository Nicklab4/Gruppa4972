...
{
    string listPair = "";                     // Строка в которой будет содержаться список пар

    bool[] tempArr = new bool[array.Length];  // Объявление временного bool массива, в котором 
                                              // будут отмечаться значения которым была найдена пара  
    ...
    for (int i = 0; i < array.Length; i++)
    {
        ...
        // Берём значение и выполняем поиск пары,
